...
const SentencePractice = ({ setIsFinished, onReset }: Props) => {
  ...
  useEffect(() => {
    ...
    setTargetTextInsert(targetText);
    setUserInputInsert(userInput);
  }, [targetText, userInput, setTargetTextInsert, setUserInputInsert]);
